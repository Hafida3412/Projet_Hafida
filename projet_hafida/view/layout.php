...
<html lang="en">
    ...
    <body>
        <div id="wrapper"> 
            ...
            <footer class="footer">
                <p>&copy; <?= date_create("now")->format("Y") ?> - <a href="#">Règlement de notre site</a> - <a href="#">Mentions légales</a> - <a href="#">FAQ</a> - <a href="index.php?ctrl=location&action=contact">Nous contacter</a></p>
            </footer>
        </div>
        <script

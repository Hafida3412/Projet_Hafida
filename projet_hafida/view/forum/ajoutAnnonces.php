...
?>
    ...
    <?php
  ?> 
    <form action="index.php?ctrl=forum&action=ajoutAnnonces" method="post"><!--on ne rajoute pas de "id" à ajoutAnnonces pour ne pas insérer l'id de l'utilisateur dans l'Url, trop dangereux.

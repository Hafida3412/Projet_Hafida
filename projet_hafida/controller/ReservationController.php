...
class reservationController extends AbstractController implements ControllerInterface{
    ...
    public function index() {
        ...
        return [
            "view" => VIEW_DIR."reservation/listAnnonces.php",
    ...
    public function detailsAnnonce($id) {
        ...
        return [
            "view" => VIEW_DIR."reservation/detailsAnnonce.php",
    ...
    public function monCompte(){
        if(Session::getUtilisateur()) {
            ...
            $this->redirectTo("reservation", "login");
        }
        return [
            "view" => VIEW_DIR . "reservation/detailsUtilisateur.php",
    ...
    public function ajoutAnnonces(){
            ...
            if(isset($_POST["submitAnnonce"])){
                ...
                // Insertion de l'annonce dans la BDD grâce à la fonction "add" du fichier Manager
                    ...
                    //var_dump("ok");die;
                        ...
                        $this->redirectTo("reservation", "index");
                }
            }
        }
        ...
        return [
            "view" => VIEW_DIR . "reservation/ajoutAnnonces.php",
    ...
    public function creationLogement() {
        ...
        if(isset($_POST["submitLogement"])) {
            ...
            if($nbChambre && $rue && $CP && $ville && $image && $typeLogement) {
                ...
                $this->redirectTo("reservation", "monCompte");
            }
        }
        
        return [
            "view" => VIEW_DIR."reservation/creationLogement.php",
    ...
    public function supprimerAnnonce($id){
        ...
        if(Session::getUtilisateur()) {
            ...
            if(Session::getUtilisateur()->getId() == $annonce->getUtilisateur()->getId()) {
                ...
                $this->redirectTo("reservation", "index", $annonce->getLogement()->getId());
            }  
            return [
                "view" => VIEW_DIR."reservation/listAnnonces.php", 
                "data" => [
